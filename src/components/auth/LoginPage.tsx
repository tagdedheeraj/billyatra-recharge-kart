...
const LoginPage = () => {
  ...
  const handleMobileLogin = (e: React.FormEvent) => {
    ...
    localStorage.setItem('isLoggedIn', 'true');
    localStorage.setItem('userMobile', loginData.mobile);
    navigate('/dashboard');
  };
            ...
            <Tabs defaultValue="email" className="w-full">
              ...
              <TabsContent value="mobile" className="space-y-4">
                <form onSubmit={handleMobileLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full h-12 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600">
                    Send OTP
                  </Button>
                </form>
              </TabsContent>
